...
osThreadId MotionDetectorHandle;
/* USER CODE BEGIN PV */
extern char key;
char hold[4];
char password[6];
...
/* USER CODE BEGIN Header_StartMotionDetector */
/**
* @brief Function implementing the MotionDetector thread.
* @param argument: Not used
* @retval None
*/
...
//	  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_15, GPIO_PIN_RESET);
  ...
  /* USER CODE END StartMotionDetector */
}
